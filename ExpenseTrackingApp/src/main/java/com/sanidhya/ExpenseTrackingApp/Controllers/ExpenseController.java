...
import com.sanidhya.ExpenseTrackingApp.Services.ExpenseService;
...
public class ExpenseController {
    ...
    @GetMapping("/expenses")
    public List<Expense> findAllExpense(Pageable page)
    {
		/*int number=1;
    ...
    public void DeletetExpenseById(@PathVariable("id")Long id) {
